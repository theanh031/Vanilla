window.addEventListener("load", () => {
    ...
    class Player {
        ...
        update(input, deltaTime, enemies) {
            ...
            // controls
            if (input && input.keys.includes("d")) {
                this.speed = 5;
            } else if (input && input.keys.includes("a")) {
                this.speed = -5;
            } else if ((input && (input.keys.includes("w") || input.keys.includes("swipe up") )) && this.onGround()) {
                this.vy -= 32;
            } else {
                this.speed = 0;
            }
    ...
    class Enemy {
        constructor(gameWidth, gameHeight) {
            ...
            this.y = this.gameHeight - this.height - 19;
            this.frameX = 0;
            this.maxFrame = 5;
            this.frameTimer = 0;
            this.fps = 20;
    ...
    function displayStatusText(context) {
        ...
        if (gameOver) {
            ...
            context.font = "40px Helvetica";
            context.fillText(
                "GAMEOVER, press ENTER or swipe down to restart !",
                canvas.width / 2,
                canvas.height / 2
            );
            context.textAlign = "center";
